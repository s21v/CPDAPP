...
//         test1字型
        ...
        //鼎 型
        LinkedList<Point> inputPoints14 = new LinkedList<>();
        inputPoints14.add(new Point(100, 100));
        inputPoints14.add(new Point(150, 100));
        inputPoints14.add(new Point(150, 150));
        inputPoints14.add(new Point(200, 150));
        inputPoints14.add(new Point(200, 100));
        inputPoints14.add(new Point(250, 100));
        inputPoints14.add(new Point(250, 200));
        inputPoints14.add(new Point(200, 200));
        inputPoints14.add(new Point(200, 250));
        inputPoints14.add(new Point(250, 250));
        inputPoints14.add(new Point(250, 350));
        inputPoints14.add(new Point(200, 350));
        inputPoints14.add(new Point(200, 300));
        inputPoints14.add(new Point(150, 300));
        inputPoints14.add(new Point(150, 350));
        inputPoints14.add(new Point(100, 350));
        inputPoints14.add(new Point(100, 250));
        inputPoints14.add(new Point(150, 250));
        inputPoints14.add(new Point(150, 200));
        inputPoints14.add(new Point(100, 200));
        ArrayList<Rect> rects14 = SplitRect.Split2Rect(inputPoints14);
        for (Rect r: rects14)
            Log.i("鼎形", "Rect:"+r);
    }
}
